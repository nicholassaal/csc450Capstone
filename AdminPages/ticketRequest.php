...
function throwValuesIntoHTMLFieldsOriginal($studentFirstName, $studentLastName, $majorName, $wordVersionEnrollment, $wordVersionOnCampus)
{ //This function is HTML code to allow for values to be passed into each given field via student selected
...
<body>
    ...
    <?php updateStudentInformation();
    discardRequestedChanges(); ?>
