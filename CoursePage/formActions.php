    ...
    ***********************************************/
    function writingReviews(){
        ...
        if($queryInsertReview){
            header("Location: http://thewoodlandwickcandleco.com/csc450Capstone/CoursePage/CoursePage.php?id=$courseCode");//Send user back to coursePage
        }
        else{
    ...
    ***********************************************/
    ...
    function replyForm(){
        ...
        if($replyMessage != ''){
            ...
            if($queryInsertReply){
                ...
                header("Location: http://thewoodlandwickcandleco.com/csc450Capstone/CoursePage/CoursePage.php?id=$courseCode#$studentReviewID");//Send user back to coursePage
            }
            else{
    ...
    if(isset($_POST['likeReviewBtn']) && $studentReviewID != $currentLoggedStudent){
        ...
        if ($sqlUpdateReviewQuery) {
            header("Location: http://thewoodlandwickcandleco.com/csc450Capstone/CoursePage/CoursePage.php?id=$courseCode#$studentReviewID");
        } else {
